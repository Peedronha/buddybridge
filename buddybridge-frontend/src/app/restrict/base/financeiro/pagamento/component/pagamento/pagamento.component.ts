...
export class PagamentoComponent {
  ...
  ngOnInit(): void {
    ...
    this.grupoacessoserviceService.getAcessosParaTela('Cadastro de Pagamentos').subscribe((acessos: AcessoDTO[]) => {
  ...
  onAdd() {
    if (this.hasAccess('Cadastrar Pagamento')) {
  ...
  onEdit(id: any) {
    if (this.hasAccess('Alterar Pagamento')) {
  ...
  onRemove(id: any) {
    if (this.hasAccess('Excluir Pagamento')) {
